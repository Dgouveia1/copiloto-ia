...
import { TENANTS, MOCK_LEADS } from './constants';
...
const App = () => {
  ...
  const [tenantId] = useState('default'); // Could be dynamic based on URL subdomain
  ...
  const renderContent = () => {
    switch (currentView) {
      case 'dashboard':
        return <DashboardView leads={MOCK_LEADS} primaryColor={tenant.primaryColor} />;
      case 'kanban':
        return (
          <KanbanBoard
            leads={MOCK_LEADS}
